    ...
    <Container fluid className='resume-container py-5'>
      <Row className='align-items-center'>
        ...
        <Col md={3}>
          ...
          <a href='https://drive.google.com/file/d/110AskkdrculugYQX8ugXhCaW7kKVDO1v/view?usp=sharing' target='_blank' rel='noopener noreferrer' className='text-decoration-none'><Button className='btn btn-lg download-btn'>Download</Button></a>
